...
if (isset($_SESSION['id'])) {
    ...
    $validExt = array ('pdf', 'txt', 'doc', 'docx', 'ppt' , 'zip','png','jpg','jpeg', 'pptx');
    if (empty($file)) {
...
?>
	...
	<div class="form-group">
	 ...
	 <div class="form-group">
        <label for="post_image">Select File</label><font color="brown"> (allowed file type: 'jpeg', 'jpg', 'png' 'pdf','doc','ppt','txt','zip' | allowed maximum size: 30 mb ) </font>
